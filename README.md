...
- The active fortress position displays a large glowing white two-digit number directly in its card space. Damaged cards immediately reveal their own large white position number over the card face, making urgent build and repair targets easy to identify.
