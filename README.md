...
- The saucer cannon fires directional beams toward individual cards. Repeated hits progressively remove card corners and add scorch/crack damage, while each completed fortress row gains an animated metal space-station frame.
