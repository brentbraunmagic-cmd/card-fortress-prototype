...
- Each recall phase contains one orange-red Elite Raider. It descends 15 percent faster and awards double base interception points. The game stores card response times and mistakes on the device, then selects the Elite from up to three of the player's weakest cards. With no prior history, it selects a random card.
