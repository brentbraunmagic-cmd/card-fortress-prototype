...
- Fortress completion awards a build-time bonus: 1,200 points at 20 seconds or faster, then 1,000, 800, 600, 400, and 200 points across progressively slower tiers through 75 seconds. Tutorials and transition animations are excluded. Phase result screens show the build time, Raider time, bonus, and total score. Saved leaderboard entries retain both phase times alongside their scores.
