...
const state = {stackKey:null,sector:0,phase:1,built:0,score:0,sectorStartScore:0,combo:1,selectedRank:null,health:Array(13).fill(0),paused:false,laserTimer:null,bombTimer:null,bomb:null,phaseTwoHits:0,recallQueue:[],reviewQueue:[],mastered:new Set(),misses:0};
...
function showVictory(){clearInterval(state.bombTimer);state.bomb?.el.remove();state.bomb=null;showLeaderboard(state.sector===SECTOR_COUNT-1)}
